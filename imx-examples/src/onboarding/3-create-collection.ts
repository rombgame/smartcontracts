...
(async (): Promise<void> => {
  ...
  const params: CreateCollectionParams = {
    name: 'ROMBNFT',
    description: 'ROMB Game NFTs',
    contract_address: collectionContractAddress,
    owner_public_key: ownerPublicKey,
    icon_url: 'https://ipfs.io/ipfs/QmbTAhoobTQspmo2rrengYE6NZ28SyYAvcRaeBhzzikDyy',
    metadata_api_url: 'https://ipfs.io/ipfs/QmPnGq39qtsy3Khi9AjmDZjQvdPjtw1Eu9QcjfHojDHLcZ',
    collection_image_url: 'https://ipfs.io/ipfs/QmbTAhoobTQspmo2rrengYE6NZ28SyYAvcRaeBhzzikDyy',
